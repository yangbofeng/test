...
//==========================================文档操作(查询)=================================================
    ...
    public static void main(String[] args) {
        FileMessage fileindex = selectDocumentById("fileindex", "h8_QAIEBCL8CHy837Hxi", FileMessage.class);
        //编码
        //String encodeToString = Base64.getEncoder().encodeToString(fileindex.getBytes());
       //解码
        /*byte[] decode = Base64.getDecoder().decode(fileindex.getContent());
        System.out.println(new String(decode));*/
        System.out.println(fileindex.getContent());
     ...
     * @time: 6:39 下午
     */
    public static <T> List<Map> selectDocumentListHighLight(String index, SearchSourceBuilder sourceBuilder, Class<T> clazz, String highLight) {
        try {
            SearchRequest request = new SearchRequest(index);
            if (sourceBuilder != null) {
                // 返回实际命中数
                ...
                highlightBuilder.requireFieldMatch(true);//多个高亮关闭
